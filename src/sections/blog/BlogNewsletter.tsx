...
export default function BlogNewsletter() {
  return (
    <section className="w-full px-4 pt-4">
      <div className="flex min-h-[108px] w-full items-center justify-center overflow-clip rounded-[24px] bg-brand-light p-4">
        <div className="flex w-full max-w-[1200px] items-center justify-center gap-16">
          ...
          <form
            className="flex w-[400px] max-w-full shrink-0 items-center gap-2 rounded-full border border-stone-100 bg-white py-0.5 pl-5 pr-0.5 transition-colors focus-within:border-brand"
